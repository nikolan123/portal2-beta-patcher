"""
Install missing assets for the March builds
"""
...
def archive_path() -> Path:
    return resource_path(Resource("build_852_1/extra_assets", ARCHIVE_NAME))
...
DEFINITION = PatchDefinition(MarchAssetsPatch(), resources=(Resource('build_852_1/extra_assets', 'assets.zip', native=False),))
