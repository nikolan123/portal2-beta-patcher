"""
Supply 852_1 with the 852_0 tempcontent
"""
...
from patches.definitions import PatchDefinition, SourceRequirement
...
from patches.build_852_1.extra_assets.from_july_2010 import CONTENT_FOLDER
...
def overlay_tree(source: Path, destination: Path, context: PatchContext, progress: ProgressCallback) -> None:
    ...
    for index, source_file in enumerate(files, start=1):
        ...
        progress(ProgressEvent("852_1.extra_assets.from_july_2009", index, max(len(files), 1), "Overlaying July 2009 assets"))


class July2009AssetsPatch:
    id = "852_1.extra_assets.from_july_2009"
    ...
    def apply(self, context: PatchContext, progress: ProgressCallback) -> None:
        ...
        temporary = context.root / ".july_2009-assets.partial"
...
DEFINITION = PatchDefinition(July2009AssetsPatch(), after=frozenset({"852_1.extra_assets.from_july_2010"}), sources=(SourceRequirement(852, 0, SOURCE_BLOB_SHA256, SOURCE_DAT_SHA256, "selected_chain", "July 2009 852_0"),))
