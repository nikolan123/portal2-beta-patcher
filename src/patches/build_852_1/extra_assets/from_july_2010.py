"""
Supply 852_1 with the 852_2 tempcontent
"""
...
class July2010AssetsPatch:
    id = "852_1.extra_assets.from_july_2010"
    ...
    def apply(self, context: PatchContext, progress: ProgressCallback) -> None:
        ...
        temporary = context.root / ".july_2010-assets.partial"
        destination = self._destination(context)
...
DEFINITION = PatchDefinition(July2010AssetsPatch(), sources=(SourceRequirement(852, 2, SOURCE_BLOB_SHA256, SOURCE_DAT_SHA256, "catalog", "July 2010 852_2"),))
