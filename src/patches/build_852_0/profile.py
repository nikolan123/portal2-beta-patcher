...
PROFILE = BuildProfile(
    ...
    optional=frozenset(['852_0.continuous_campaign', '852_0.dialogue', '852_0.extra_assets', '852_0.hammer', '852_0.hl2_assets', '852_0.multiplayer', '852_0.sound_manifest', '852_0.subtitles', 'goldberg', 'thread_fix']),
    required=frozenset(
