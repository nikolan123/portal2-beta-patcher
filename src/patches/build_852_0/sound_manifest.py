"""
Repair sound manifest so portal 2 loads the correct files
"""
...
DEFINITION = PatchDefinition(SoundManifestPatch(), dependencies=frozenset({"852_0.hl2_assets"}), requirements=frozenset({"hl2"}))
