"""Install multiplayer runtime fixes for 852_0."""
...
def bundled_path(name: str) -> Path:
    return resource_path(Resource("build_852_0/multiplayer", name, native=True))
...
DEFINITION = PatchDefinition(Multiplayer8520Patch(), after=frozenset({"852_0.hammer"}), resources=(Resource('build_852_0/multiplayer', 'asi_d3d9.dll', native=True), Resource('build_852_0/multiplayer', 'asi_dxwrapper.dll', native=True), Resource('build_852_0/multiplayer', 'asi_dxwrapper.ini', native=True), Resource('build_852_0/multiplayer', 'asi_LICENCE-dxwrapper.txt', native=True), Resource('build_852_0/multiplayer', 'multiplayer.asi', native=True),))
