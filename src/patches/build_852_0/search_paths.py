"""
Mount the beta's required content folders and optional HL2 assets
"""
...
DEFINITION = PatchDefinition(SearchPathsPatch(), after=frozenset({"852_0.hl2_assets"}))
